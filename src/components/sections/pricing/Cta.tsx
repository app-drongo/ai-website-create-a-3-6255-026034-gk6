...
export default function Cta() {
  ...
  const stats = [
    { value: '15K+', label: 'Businesses', icon: Users },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join 15,000+ businesses using InvoiceFlow to streamline their billing process.
                Create professional invoices and get paid in 2 minutes or less.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Bank-level security with 99.9% payment success rate
              </p>
            </div>
